...
from generate.base_qformer import generate
from lit_gpt import Tokenizer
from lit_gpt.gentrans import GPTWithQFormer, Block, Config
...
#    pr, gt = [], []
    ...
    for datapoint in data:
        ...
        encoder_output = datapoint['encoder_output'].to(model.device)
#        print("Encoded input for model:", encoded)
