...
def main():
    ...
    # Open output files
    with open(emotion_path, 'w', encoding='utf-8') as emo_file, open(inferences_path, 'w', encoding='utf-8') as inf_file, open(ground_truths_path, 'w', encoding='utf-8') as gt_file:
        for item in data:
